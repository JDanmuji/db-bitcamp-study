...
<div class="container">
 <table border="1" cellpadding="5" cellspacing="0">
  ...
  <tbody>
    ...
    <div class="selectBox">
 		<select name="search" id="search" style="width: 90px;">
     	<option value="writer">작성자</option>
     	<option value="subject">제목</option>
    	</select>
 		<input type="text" name="listSearch" id="listSearch" style="width: 120px;">
 		<input type="button" value="검색" onclick="checkWrite()">
 	</div>
 </div>
