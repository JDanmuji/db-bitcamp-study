								  ...
								  <tbody>
								  	...
								  	<c:forEach var="list" items="${list}">
								  		<tr>
								        	...
								        	<td width="200"><a class="subjectA" href="/board/boardView.do?seq=${list.seq}">${list.subject}</a></td>
		...
		<!-- Scripts -->
			...
			<script type="text/javascript">
				...
				function checkWrite() {
					...
					location.href = "boardList.do?pg=1&search=" + search + "&listSearch=" + listSearch;
				}
